...
@section('body')
    <div class="dashboard container">
        ...
        <div class="main-content col-md-9">
            ...
            @endif
            <form action="{{ route('frontend.dashboard.updatepost') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <section id="posts-section" class="posts-section">
                    ...
                    <ul class="list-unstyled user-posts">
                        ...
                        <li class="post-item">
                            ...
                            <!-- Editable Title -->
                            <input type="text" class="form-control mb-2 post-title" value="{{ $post->title }}"
                                name='title' />

                            <!-- Editable Content -->
                            <textarea class="form-control mb-2 post-content" id="body-content" name="desc">
                            {!! $post->desc !!}
                            </textarea>

                            <!-- Image Upload Input for Editing -->
                            <input type="file" id="post_images" class="form-control mt-2 edit-post-image"
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input enable-comments" type="checkbox" name="comment_able"
                            ...
                            <div class="post-actions mt-2">
                                ...
                                <a href="{{ route('frontend.dashboard.profile') }}" type="submit"
