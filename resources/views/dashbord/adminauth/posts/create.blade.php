                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('admin.post.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" name="images[]" id="postImage" accept="image/*"
                                    multiple>
                            </div>
                            @error('images')
                                <div class="alert alert-warning">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="desc" rows="5" placeholder="Write post content here..." id="postContent" value="{{@old('desc')}}"> </textarea>
                            </div>
                            @error('desc')
                                <div class="alert alert-warning">
                                    <strong> {{ $message }}</strong>
